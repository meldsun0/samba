...
public class HeaderRecordContainer
    extends Container2<HeaderRecordContainer, SszBytes32, SszUInt256> {

  public HeaderRecordContainer(Bytes32 blockHash, UInt256 totalDifficulty) {
    super(
        HeaderRecordContainerSchema.INSTANCE,
        SszBytes32.of(blockHash),
        SszUInt256.of(totalDifficulty));
  }
  ...
  public static class HeaderRecordContainerSchema
      extends ContainerSchema2<HeaderRecordContainer, SszBytes32, SszUInt256> {
