...
public class BucketEntry {
    ...
    public BucketEntry(final LivenessManager livenessManager, final NodeRecord node) {
        this(livenessManager, node, NEVER);
    }

    public BucketEntry(final LivenessManager livenessManager, final NodeRecord node, final long lastLivenessConfirmationTime) {
