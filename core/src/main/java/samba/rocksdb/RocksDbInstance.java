...
import org.rocksdb.*;
import samba.rocksdb.exceptions.ShuttingDownException;
import samba.rocksdb.keyvalue.ColumnEntry;
...
public class RocksDbInstance implements KvStoreAccessor {
    ...
    public synchronized KvStoreTransaction startTransaction() {
        assertOpen();
        RocksDbTransaction tx = new RocksDbTransaction(db, defaultHandle, columnHandles, openTransactions::remove);
