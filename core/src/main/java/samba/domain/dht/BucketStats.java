...
public class BucketStats {
  ...
  private final int[] allNodeCounts = new int[MAXIMUM_BUCKET + 1];
  private final int[] liveNodeCounts = new int[MAXIMUM_BUCKET + 1];
  ...
  public String toString() {
    ...
    for (int distance = 0; distance <= MAXIMUM_BUCKET; distance++) {
