...
public class Discv5Service extends Service implements Discv5Client {
    ...
    public Discv5Service(
        ...
        final NodeRecordBuilder nodeRecordBuilder = this.createNodeRecordBuilder(discoveryConfig, secretKey, seqNo);
        ...
        this.discoverySystem = createDiscoverySystem(discoveryConfig,
                secretKey, incomingRequestTalkHandler, discoverySystemBuilder, nodeRecordBuilder);
    ...
    private DiscoverySystem createDiscoverySystem(DiscoveryConfig discoveryConfig, SECP256K1.SecretKey secretKey, IncomingRequestTalkHandler incomingRequestTalkHandler, DiscoverySystemBuilder discoverySystemBuilder, NodeRecordBuilder nodeRecordBuilder) {
    ...
    private NodeRecordBuilder createNodeRecordBuilder(DiscoveryConfig discoveryConfig, SECP256K1.SecretKey secretKey, UInt64 seqNo) {
