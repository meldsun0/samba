...
public class FindContentContainer extends Container1<FindContentContainer, SszByteList> {
  ...
  public FindContentContainer(Bytes contentKey) {
    super(
        FindContentSchema.INSTANCE,
        SszByteListSchema.create(PortalWireMessage.MAX_CUSTOM_PAYLOAD_BYTES).fromBytes(contentKey));
  }
  ...
  public static class FindContentSchema
      extends ContainerSchema1<FindContentContainer, SszByteList> {
