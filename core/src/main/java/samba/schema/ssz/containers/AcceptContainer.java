...
public class AcceptContainer extends Container2<AcceptContainer, SszByteVector, SszBitlist> {
    ...
    public AcceptContainer(Bytes connectionId, Bytes contentKeysBitList) {
        super(AcceptSchema.INSTANCE, SszByteVector.fromBytes(connectionId), createSszBitlist(contentKeysBitList));
    }
    ...
    public static class AcceptSchema extends ContainerSchema2<AcceptContainer, SszByteVector, SszBitlist> {
