...
public class Discv5UpdateNodeInfoTest {
    ...
    private final String ENR = "enr:-LS4QOhHz1hd6Sg6dAtYL1XDsMN-8Quk0dmH_RhY50nVAGApdpEcK15YxNZhhDFIqNAACi8E3H1GIbtKgQsaM2TDVkyEZ1t3LGOqdCBjMjhjMzFmODViNTU4NDM0MWE0ZDQ0NTliODg2M2VjYThkOTRhY2Q2gmlkgnY0gmlwhKwRAAWJc2VjcDI1NmsxoQLv0EURHW2Rbcuk5hmsN7ZjorMOktgSBDB6n_kYOo-wc4N1ZHCCIzE";
    ...
    public void shouldReturnCorrectResult() {
        final JsonRpcRequestContext request =
                new JsonRpcRequestContext(new JsonRpcRequest(JSON_RPC_VERSION, DISCV5_UPDATE_NODE_INFO, new Object[] {
                        "127.0.0.1:9000", true
                }));
        ...
        JsonRpcResponse expected = new JsonRpcSuccessResponse(request.getRequest().getId(), buildNodeInfo(homeNodeRecord));
