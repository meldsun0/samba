                        ...
                        .openApiInfo(
                                openApi ->
                                        openApi
                                                ...
                                                .description(
                                                        "A minimal API specification for the Portal node, which ...")
...
//                                NodeSyncingException.class, (throwable) -> HttpErrorResponse.serviceUnavailable())
                        .exceptionHandler(ServiceUnavailableException.class, (throwable) -> HttpErrorResponse.serviceUnavailable())
//                        .exceptionHandler(
...
//                                (throwable) -> HttpErrorResponse.badRequest(throwable.getMessage()))
                        .exceptionHandler(JsonProcessingException.class, (throwable) -> HttpErrorResponse.badRequest(throwable.getMessage()))
                        .exceptionHandler(IllegalArgumentException.class, (throwable) -> HttpErrorResponse.badRequest(throwable.getMessage()))
                        // Beacon Handlers
