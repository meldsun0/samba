        ...
        ScheduledExecutorService scheduler =
                Executors.newSingleThreadScheduledExecutor(
                        (new ThreadFactoryBuilder())
                                ...
                                .setDaemon(false)
                                .build());
        ExecutorService workerPool = executorFactory.newCachedThreadPool(name, maxThreads, maxQueueSize, (new ThreadFactoryBuilder()).setNameFormat(name + "-async-%d").setDaemon(false).setPriority(threadPriority).build());
