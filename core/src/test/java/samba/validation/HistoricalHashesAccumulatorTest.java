...
public class HistoricalHashesAccumulatorTest {
  ...
  public void testUpdateAccumulator() {
    ...
    System.out.println(
        "After updating with Genesis Block Header: " + accumulator.hashTreeRoot().toHexString());
    HistoricalHashesAccumulatorContainer genesisAccumulator =
        new HistoricalHashesAccumulatorContainer(
            List.of(), new EpochRecordList(List.of(genesisHeaderRecordContainer)));
