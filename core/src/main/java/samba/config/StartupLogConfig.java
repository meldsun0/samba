...
public class StartupLogConfig {
    ...
    public List<String> getReport() {
        ...
        final String host = String.format("Host Configuration | Maximum Heap Size: %s, Total Memory: %s, CPU Cores: %d", maxHeapSize, memory, cpuCores);
        final String restApi = portalNodeRestApiEnabled ? String.format("Rest Api Configuration | Enabled: true, Listen Address: %s, Port: %s, Allow: %s",
